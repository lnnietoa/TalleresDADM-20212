...
import com.example.reto9maps.databinding.ActivityMapsBinding;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private static int M_MAX_ENTRIES = 5;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        circle = map.addCircle(new CircleOptions()
                .clickable(false).visible(false).center(defaultLocation).radius(radius));
    ...
    private void getDeviceLocation() {
        ...
        catch (SecurityException e)  { Log.e("Exception: %s", e.getMessage(), e); }
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.opcion_menu, menu);
        return true;
    }
    ...
    public static void updateCircle(){
        circle.setCenter(new LatLng(lastKnownLocation.getLatitude(), lastKnownLocation.getLongitude()));
        circle.setStrokeColor(Color.parseColor("#A569BD"));
